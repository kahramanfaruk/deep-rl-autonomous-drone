...
class DroneNavigationEnv(gym.Env):
    ...
    def __init__(self, grid_size=(10, 15), cell_size=100):
        ...
        # Generate terrain (1=valley, 0=mountain)
...
# TODO: Add a new drone agent (helper agent) which detects the fire and then transers the location (goal position) to the main agent
